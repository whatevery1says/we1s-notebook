...
bib.dfr = function(e) {
    ...
    i.citation = function(e) {
        ...
        t = t.replace(/\t/g, "");
        t = t.replace(/\t/g, "");
        // ADDED: Adds custom fields to the output string.
        // by Scott Kleinman, Feb 5 2019.
        var props = Object.keys(e);
        var k;
        for (k = 0; k < props.length; k++) {
            if (k > 7) {
                var customProp = props[k].charAt(0).toUpperCase() + props[k].slice(1);
                t += " " + customProp + ": " + e[props[k]] + '.';
            }
        }
        ////////////////////////////////////////////////
        return t
...
view.topic.words = function(e) {
    ...
    t.append("td").append("a").attr("href", function(e) {
        return "#/word/" + e.word
    }).text(function(e) {
        return e.word
    });
